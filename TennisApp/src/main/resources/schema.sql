...
CREATE TABLE court (
                       ...
                       FOREIGN KEY (tennis_club_id) REFERENCES tennis_club(id),
...
-- Insert test data into the tennis_club table
...
INSERT INTO court (name, deleted, tennis_club_id, surface_type_id)VALUES
